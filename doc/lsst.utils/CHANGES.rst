lsst-utils v30.0.10 (2026-07-20)
================================
...
- Improved the coverage of ``disable_implicit_threading``.
  ...
  A warning is now logged if ``threadpoolctl`` is not installed since thread pools of already-loaded libraries can then no longer be limited. (`DM-55482 <https://rubinobs.atlassian.net/browse/DM-55482>`_)
